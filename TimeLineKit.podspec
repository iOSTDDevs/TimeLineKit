#
#  Be sure to run `pod spec lint TimeLineKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Daniel Rocha" => "danielrochadesousa@gmail.com" }
  # Or just: spec.author    = "Daniel Rocha"
  # spec.authors            = { "Daniel Rocha" => "" }
  # spec.social_media_url   = "https://twitter.com/Daniel Rocha"
  ...
  spec.source_files = "TimeLineKit/**/*.{swift}"
